...
int main() 
{
    ...
    double burgerTotal = 0, pizzaTotal = 0, icecreamTotal = 0, sandwichTotal = 0, paymentAmount = 0, change = 0, totalPrice = 0, govTax = 0, totalPriceWithTax = 0;
    ...
    for (int i = 0; i < people; i++) 
	{
        ...
        switch (itemCode) 
		{
            case 1: 
			{
                // Call burger function and ensure it returns the price
                double burger = // Code to get burger price
                burgerTotal += burger;
                burgerQuantity++;
                break;
            }
            case 2: 
			{
                // Call pizza function and ensure it returns the price
                double pizza = // Code to get pizza price
                pizzaTotal += pizza;
                pizzaQuantity++;
                break;
            }
            case 3: 
			{
                // Call ice cream function and ensure it returns the price
                double icecream = // Code to get ice cream price
                icecreamTotal += icecream;
                icecreamQuantity++;
                break;
            }
            case 4: 
			{
                // Call sandwich function and ensure it returns the price
                double sandwich = // Code to get sandwich price
                sandwichTotal += sandwich;
                sandwichQuantity++;
                break;
            }
        }
...
int displayMenu() // This contains the entire menu of our food ordering system
{
	int itemCode;
    cout<<"--------------------------------------------------------"<<endl;
    cout<<setw(28)<<"RESTAURANT MENU"<<endl;
    cout<<"--------------------------------------------------------"<<endl;
    cout<<"--------------------------------------------------------"<<endl;
