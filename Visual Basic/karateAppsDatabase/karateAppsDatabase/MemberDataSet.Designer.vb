    ...
    Partial Public Class MembersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Members` SET `Last_Name` = ?, `First_Name` = ?, `Phone` = ?, `Date_Joined"& _ 
                "` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Last_Name` IS NULL) OR (`Last_Name` = ?"& _ 
                ")) AND ((? = 1 AND `First_Name` IS NULL) OR (`First_Name` = ?)) AND ((? = 1 AND "& _ 
                "`Phone` IS NULL) OR (`Phone` = ?)) AND ((? = 1 AND `Date_Joined` IS NULL) OR (`D"& _ 
                "ate_Joined` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.karateAppsDatabase.My.MySettings.Default.karate2002_2003ConnectionString
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As MemberDataSet.MembersDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As MemberDataSet.MembersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As MemberDataSet.MembersDataTable = New MemberDataSet.MembersDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As MemberDataSet.MembersDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Last_Name As String, ByVal Original_First_Name As String, ByVal Original_Phone As String, ByVal Original_Date_Joined As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Last_Name As String, ByVal First_Name As String, ByVal Phone As String, ByVal Date_Joined As Global.System.Nullable(Of Date), ByVal Original_ID As Integer, ByVal Original_Last_Name As String, ByVal Original_First_Name As String, ByVal Original_Phone As String, ByVal Original_Date_Joined As Global.System.Nullable(Of Date)) As Integer
            If (Last_Name Is Nothing) Then
