...
Partial Public Class PaymentsDataSet
    ...
    Partial Public Class PaymentsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddPaymentsRow(ByVal Member_ID As Integer, ByVal Payment_Date As Date, ByVal Amount As Decimal) As PaymentsRow
...
Namespace PaymentsDataSetTableAdapters
    ...
    Partial Public Class PaymentsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Payments` (`Member_ID`, `Payment_Date`, `Amount`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Payments` SET `Member_ID` = ?, `Payment_Date` = ?, `Amount` = ? WHERE ((`"& _ 
                "ID` = ?) AND ((? = 1 AND `Member_ID` IS NULL) OR (`Member_ID` = ?)) AND ((? = 1 "& _ 
                "AND `Payment_Date` IS NULL) OR (`Payment_Date` = ?)) AND ((? = 1 AND `Amount` IS"& _ 
                " NULL) OR (`Amount` = ?)))"
