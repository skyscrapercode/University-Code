...
Partial Public Class testDataSet
    ...
    Partial Public Class CustomerDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddCustomerRow(ByVal Name As String, ByVal Age As Integer, ByVal DOB As Date) As CustomerRow
            Dim rowCustomerRow As CustomerRow = CType(Me.NewRow,CustomerRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Name, Age, DOB}
    ...
    Partial Public Class CustomerTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Customer` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Nam"& _ 
                "e` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age` = ?)) AND ((? = 1 AND `DOB` IS"& _ 
                " NULL) OR (`DOB` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Customer` (`Name`, `Age`, `DOB`) VALUES (?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Customer` SET `Name` = ?, `Age` = ?, `DOB` = ? WHERE ((`ID` = ?) AND ((? "& _ 
                "= 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.testDatabase.My.MySettings.Default.testConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Name, Age, DOB FROM Customer"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Name As String, ByVal Original_Age As Global.System.Nullable(Of Integer), ByVal Original_DOB As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal Age As Global.System.Nullable(Of Integer), ByVal DOB As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal Age As Global.System.Nullable(Of Integer), ByVal DOB As Global.System.Nullable(Of Date), ByVal Original_ID As Integer, ByVal Original_Name As String, ByVal Original_Age As Global.System.Nullable(Of Integer), ByVal Original_DOB As Global.System.Nullable(Of Date)) As Integer
            If (Name Is Nothing) Then
